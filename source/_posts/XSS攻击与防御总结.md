...
在input中输入,点击保存后，发现居然弹出了cookie信息了啊。 这有点严重，具体看图：
...
1. 在input框输入下图中的img标签，类似的JavaScript标签像**scrip,img,svg**等都可能会引发此问题。
...
beforeSend: function(xhr) {
 	xhr.setRequestHeader("Cookie", 	'SESS83c26757d9118c6bafca4e38b2233563=G9oaLEcjP1BPlZQ5E4eSSgu0mfk2WqW	rggxLNo5DsLk');  
}
```
